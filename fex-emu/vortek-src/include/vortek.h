...
// Upstream assumed __ANDROID__ means server-side build (winlator app). For
// native-Wine-on-Android we build the CLIENT against Bionic NDK, so the
// auto-enable is gated on VT_CLIENT not being defined.
