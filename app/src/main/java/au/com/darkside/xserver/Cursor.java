...
public class Cursor extends Resource {
    ...
    private static final int _glyphs[][] = {{0, 7, 7}, {0, 14, 1}, {0, 4, 10}, {0, 4, 10}, {0, 14, 4}, {0, 7, 7}, {0, 1, 14}, {0, 14, 14}, {0, 7, 14}, {0, 8, 10}, {0, 8, 8}, {0, 5, 1}, {0, 8, 8}, {0, 6, 3}, {0, 7, 9}, {0, 7, 7}, {0, 7, 7}, {0, 7, 7}, {0, 7, 7}, {0, 6, 6}, {0, 7, 6}, {0, 6, 8}, {0, 14, 0}, {0, 14, 0}, {0, 7, 6}, {0, 7, 7}, {0, 8, 8}, {0, 14, 3}, {0, 2, 0}, {01, 12, 0}, {02, 0, 1}, {0, 6, 8}, {0, 8, 8}, {0, 8, 7}, {0, 1, 1}, {0, 1, 7}, {0, 1, 8}, {0, 8, 8}, {0, 1, 10}, {0, 10, 10}, {0, 14, 5}, {0, 8, 8}, {0, 4, 1}, {0, 11, 15}, {0, 7, 12}, {0, 5, 6}, {0, 5, 8}, {0, 8, 1}, {0, 14, 7}, {0, 10, 8}, {0, 8, 8}, {0, 7, 7}, {0, 8, 0}, {0, 4, 15}, {0, 7, 4}, {0, 0, 4}, {0, 15, 4}, {0, 4, 0}, {0, 4, 7}, {0, 11, 0}, {0, 8, 8}, {0, 6, 7}, {0, 10, 2}, {0, 7, 7}, {0, 7, 7}, {0, 7, 7}, {0, 1, 1}, {0, 1, 1}, {0, 14, 1}, {0, 7, 1}, {0, 8, 1}, {0, 4, 0}, {0, 1, 1}, {0, 8, 2}, {0, 10, 1}, {0, 15, 9}, {0, 4, 8}};
    ...
    /**
     * Constructor from a bitmap (used by RENDER CreateCursor).
     */
    public Cursor(int id, XServer xServer, Client client, Bitmap bitmap, int hotspotX, int hotspotY) {
        super(CURSOR, id, xServer, client);
        if (bitmap != null && !bitmap.isRecycled()) {
            _bitmap = bitmap.copy(Bitmap.Config.ARGB_8888, false);
        } else {
            _bitmap = Bitmap.createBitmap(1, 1, Bitmap.Config.ARGB_8888);
        }
        _hotspotX = hotspotX;
        _hotspotY = hotspotY;
        _foregroundColor = 0xff000000;
