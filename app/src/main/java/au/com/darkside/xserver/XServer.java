...
public class XServer {
    ...
    public XServer(Context c, int port, String windowManagerClass) {
        ...
        _extensions.put("RENDER", new Extension(Extensions.Render, (byte) 0, au.com.darkside.xserver.Xext.XRender.ErrorBase));
        ...
        _formats.add(new Format((byte) 24, (byte) 32, (byte) 32));
        _formats.add(new Format((byte) 32, (byte) 32, (byte) 32));
