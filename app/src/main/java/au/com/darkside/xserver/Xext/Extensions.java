...
public class Extensions {
    ...
    public static final byte Render = -123;
    ...
    public static void processRequest(XServer xServer, Client client, byte opcode, byte arg, int bytesRemaining) throws IOException {
        ...
        switch (opcode) {
            ...
            case XTEST:
                ...
                break;
            case Render:
                XRender.processRequest(xServer, client, opcode, arg, bytesRemaining);
                break;
            case Randr:
                XRandr.processRequest(xServer, client, opcode, arg, bytesRemaining);
                break;
            case Sync:
                XSync.processRequest(xServer, client, opcode, arg, bytesRemaining);
                break;
            case Xinerama:
                au.com.darkside.xserver.Xext.Xinerama.processRequest(xServer, client, opcode, arg, bytesRemaining);
                break;
            case XKB:
