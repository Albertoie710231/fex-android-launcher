    ...
    public void handleRequest(XClient client, XInputStream inputStream, XOutputStream outputStream)
        ...
        switch (opcode) {
            ...
            case ClientOpcodes.QUERY_DEVICE:
                ...
                break;
            default:
                Log.w("Winlator", String.format("XInput2Extension: unhandled minor opcode=%d, requestData=%d, requestLength=%d", opcode, client.getRequestData(), client.getRemainingRequestLength()));
                inputStream.skip(client.getRemainingRequestLength());
